...
const packagingItems = ['No Sugar', 'Splenda', 'No Ice', 'One Pump', 'Warm'];
...
const rows = [
  ...
  })),
  {
    ...
    source_option: 'Creatine Wheyl',
    mapped_category: 'ADD-ONS',
    mapped_item_name: 'Creatine Wheyl',
    notes: 'Seeded: misc add-on option',
  },
  {
    ...
    mapped_category: 'ADD-ONS',
    mapped_item_name: 'Creatine Wheyl',
    notes: 'Seeded: delivery misc add-on option',
  },
].map((r) => ({
  ...r,
  priority: 100,
