...
const packagingItems = ['Stirrer', 'Half-Shot Espresso'];

const rows = packagingItems.map((item) => ({
  ...
  priority: 100,
  is_active: true,
  source_cat_norm: normalizeText('PACKAGING'),
  source_item_norm: normalizeText(item),
  source_opt_norm: '',
}));
