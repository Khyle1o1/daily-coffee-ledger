-- 025b: Coolify self-hosted is CPU/TOAST-bound (128MB shared_buffers).
-- Per-key jsonb_build_object projection made generate slower than raw select.
-- Keep date-pruning + drop unmappedSummary; client still slims keys after download.
